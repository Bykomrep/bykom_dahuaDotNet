...
namespace SDKPlayDemo
{
    partial class frmAbout : Form
    {
        public frmAbout()
        {
            ...
            this.labelVersion.Text = String.Format("版本    {0} \nSDK版本 {1}", AssemblyVersion,SDKVersion);
        ...
        public string SDKVersion
        {
            get
            {
                //return Convert.ToString(DHPlay.DHGetSdkVersion());
                return DHPlay.DHGetSdkVersion("A.B.C");
            }
        }
        #endregion
